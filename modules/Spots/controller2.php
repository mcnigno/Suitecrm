...
EOF;
    ...
    public function action_createActivitiesSpotsData($filepath)
    {
        ...
        SELECT
            ...
            , calls.date_start
            , RTRIM(LTRIM(CONCAT(COALESCE(users.first_name,''),' ',COALESCE(users.last_name,'')))) as assignedUser,
            DATE(calls.date_start) as dateStartDay,
            TIME(calls.date_start) as timeStartDay
...
EOF;
        ...
        SELECT
            ...
            , meetings.date_start
            , RTRIM(LTRIM(CONCAT(COALESCE(users.first_name,''),' ',COALESCE(users.last_name,'')))) as assignedUser,
            DATE(meetings.date_start) as dateStartDay,
            TIME(meetings.date_start) as timeStartDay,
...
EOF;
        ...
        SELECT
            ...
            , tasks.date_start
            , RTRIM(LTRIM(CONCAT(COALESCE(users.first_name,''),' ',COALESCE(users.last_name,'')))) as assignedUser,
            DATE(tasks.date_start) as dateStartDay,
            TIME(tasks.date_start) as timeStartDay
