...
EOF;
        ...
        while ($row = $db->fetchByAssoc($result)) {
            ...
            $x->{$mod_strings['LBL_AN_ACTIVITIES_DATE_CREATED_DAY']} = $row['dateCreatedDay'];
            $x->{$mod_strings['LBL_AN_ACTIVITIES_DATE_CREATED_WEEK']} = $row['dateCreatedWeek'];
            $x->{$mod_strings['LBL_AN_ACTIVITIES_DATE_CREATED_MONTH']} = $row['dateCreatedMonth'];
            $x->{$mod_strings['LBL_AN_ACTIVITIES_DATE_CREATED_QUARTER']} = $row['dateCreatedQuarter'];
            $x->{$mod_strings['LBL_AN_ACTIVITIES_DATE_CREATED_YEAR']} = $row['dateCreatedYear'];
