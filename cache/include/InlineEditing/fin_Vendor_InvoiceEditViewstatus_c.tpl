...
{else}
	...
	<span class="id-ff multiple">
	    <button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.status_c.name}-image"></button><button type="button"
	        ...
	        title="Clear"
	        onclick="SUGAR.clearRelateField(this.form, '{$fields.status_c.name}-input', '{$fields.status_c.name}');sync_{$fields.status_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
	</span>
